...
class ShoppingItemsNotifier extends StateNotifier<List<ShoppingItem>> {
  ...
  ShoppingItemsNotifier()
      : super(Hive.box<ShoppingItem>('shopping_items_box').values.toList());
  ...
  void deleteItem(int index) {
    ...
    final box = Hive.box<ShoppingItem>('shopping_items_box');
    box.deleteAt(index); // Hive deletes by index
  }
